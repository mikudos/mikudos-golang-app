...
.PHONY: proto
proto:
	protoc --proto_path=${GOPATH}/src:. --go_out=plugins=grpc:. proto/greeter/*.proto
	protoc --proto_path=${GOPATH}/src:. --go_out=plugins=grpc:. proto/helloworld/*.proto
